...
def scrape_url_bfs(start_url, visited_urls, all_urls, output_file, max_links=1, max_total_urls=25):
    ...
    while queue and total_visited_urls < max_total_urls:
        ...
        try:
            ...
            text = soup.select_one("body > div.container").get_text()
...
if __name__ == "__main__":
    ...
    scrape_url_bfs(start_url, visited_urls, all_urls, output_file, max_links=25)
